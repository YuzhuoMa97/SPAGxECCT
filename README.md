...
**SPAGxEmix<sub>CCT</sub>+ is a scalable and accurate analytical G×E framework which can control for both population structure and family relateness for any population structures and family structures, enen for cohorts containing individuals from multi-ancestry or multi-way admixed populations with ancestry-specific MAFs and case-control ratios!**
