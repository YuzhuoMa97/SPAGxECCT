...
As an extension of SPAGxE<sub>CCT</sub>, SPAGxEmix<sub>CCT</sub> is a G×E analysis framework which is applicable to study cohorts containing individuals from multiple ancestries or admixed populations. 
